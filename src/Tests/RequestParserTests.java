...
public class RequestParserTests
{
    ...
    {
        String method = SUT.buildInfoFromHeader("GET /example/file.html HTTP/1.1").method;
    ...
    {
        String method = SUT.buildInfoFromHeader("POST /example/file.html HTTP/1.1").method;
    ...
    {
        String method = SUT.buildInfoFromHeader("PUT /example/file.html HTTP/1.1").method;
    ...
    {
        String path = SUT.buildInfoFromHeader("PUT / HTTP/1.1").path;
        assertEquals("/", path);
    }
    ...
    {
        String path = SUT.buildInfoFromHeader("PUT /somewhere/else HTTP/1.1").path;
